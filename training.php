...
<html lang="fr">
  ...
  <div class="container-fluid">
    <a class="navbar-brand text-uppercase fw-bolder mx-4 py-3" href="#">La Belle Assiette</a>
  ...
  <!-- Creation du menu -->
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item pe-4">
          <a class="nav-link active" href="#">Découvrir</a>
        </li>
        <li class="nav-item pe-4">
          <a class="nav-link active" href="#">Contact</a>
        </li>
         <li class="nav-item pe-4">
          <a class="btn btn-order" href="#" rounded-0>Commander maintenant</a>
        </li>
      </ul>
    </div>
  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col md-6">
                      <div class="card-body">
                        ...
                        <p class="card-text"><a href="#" class="btn">Commandez</a></p>
                      </div>
                    </div>
                  </div>
      ...
      <section class="caleb-menu py-5 merriweather">
        <div class="container">
            ...
            <div class="card text-center bg-transparent">
              <div class="card-header">
                <ul class="nav nav-tabs justify-content-center  card-header-tabs">
                  <li class="nav-item">
                    <a href="#" class="nav-link active" aria-current="true">Resto</a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link text-light">Bar</a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link text-light">Hotel</a>
                  </li>
                </ul>
          ...
          <div class="row row-cols-1 row-cols-md-2 g-4">
            <div class="col">
              <div class="card">
                <img src="images/burger.jpg" alt="" class="card-img-top"/>
                <div class="card-body">
      ...
      <section class="order-form py-5">
        <div class="container">
          <h2 class="merriweather text-light text-center mb-4"> Contactez nous </h2>
